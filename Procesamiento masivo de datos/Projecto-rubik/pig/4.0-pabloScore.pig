...
final_results = FOREACH results_country GENERATE name, time_country, nPerson , (time_country + (totalAverage/nPerson)) as pablo_score;
...
STORE results_ordered INTO '/uhadoop2019/elsueco/results_project7/';
