...
average_per_country = FOREACH results_by_country GENERATE group AS countryId, AVG(results_person.time) AS time_country;
...
STORE results_ordered INTO '/uhadoop2019/elsueco/results_project/';
