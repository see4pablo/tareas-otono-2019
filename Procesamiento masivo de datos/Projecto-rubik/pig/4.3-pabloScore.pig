...
final_results = FOREACH prefinal_results2 GENERATE name, time_country, nPerson , ((time_country + (totalAverage*(totalPeople/nPerson)))/2) as pablo_score;
...
STORE results_ordered INTO '/uhadoop2019/elsueco/results_project10/';
